    ...
    <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Deleted Single Slider !</h5>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-12 p-1">
                                <p>Are You Sure to Deleted Single Slider !</p>
...
async  function  itemDelete(){
            ...
            showLoader();
            let res=await axios.post("/delete-slider",{id:id,file_path:deleteFilePath})
            hideLoader();
            if(res.data===1){
